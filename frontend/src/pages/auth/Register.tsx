...
import { RegisterInput } from "../../services/json/inputsData/register.input";
      ...
      <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-violet-50/50 to-purple-50 px-4">
        ...
        >
          ...
          <div className="flex justify-center items-center">
            {previewImage && <img src={previewImage} alt="img" height={"100px"} width={"100px"} className="rounded-full"/>}
          </div>
          ...
          <h1 className="text-center">Already have an account? <button onClick={()=> navigate("/login")}>Login</button></h1>
        </form>
      </div>
    </>
  );
